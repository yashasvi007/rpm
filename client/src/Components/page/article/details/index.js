...
class ArticleDetails extends Component {
      ...
      <Fragment>
        <div className="flex justify-content-space-between pb16 article-title">
          <div className="flex column">
            <div className="bold fontsize22 dark">{title}</div>
          ...
          <div className="flex-1 mr8 ml8 flex justify-content-end">
  ...
  getSource = () => {
    ...
    return (
      <div className="mt30 mb16 pb16">
        <span className=" subdued mr4 ">
          {this.formatMessage(messages.source)}
        </span>
        <span>
          <a className="dark medium" href={url}>
            {url}
          </a>
        </span>
      </div>
