...
class PatientResponseHeader extends Component {
  ...
  render() {
    ...
    return (
      <Fragment>
        <div className="fixed_header_sticky flex align-items-center justify-content-space-between ">
          <div className="  text-align-l flex column align-items-start justify-content-space-between">
            ...
            >
              ...
              <div className="m10 dot dark" />

              <div className="dark fontsize12">{surveyTitle}</div>

              <div className="dot dark ml10 mr10 " />
              <div className="dark fontsize12">
                {formatMessage(messages.patientsResponses)}
              </div>
            </div>
          </div>
          <div className="flex justify-content-end pr20 align-items-center">
