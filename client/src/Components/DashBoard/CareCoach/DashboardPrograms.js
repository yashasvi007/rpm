...
class DashBoardPrograms extends Component {
  ...
  render() {
    ...
    return (
      <Fragment>
        <div className={"CarecoachDashboard-program "}>
          <div className={"flex column align-items-center program-body"}>
            <Row className={"clearFix-104"} />
            <Row className={"program-body-row1"} type={"flex"} align={"middle"}>
              <Col className={"row1-left"} lg={6}>
                <span className="dashboard-heading">
                  {formatMessage(messages.careCoachProgramHeading)}
                </span>
              </Col>
              <Col className={"row1-right"} lg={6}>
                <Select
                  ...
                  suffixIcon={
                    <img alt="" src={DownArrow} className="arrowImg" />
                  }
                >
                  {/* <Option value={ALL_SORT_BY.RECENTLY_UPDATED}>
                    {formatMessage(
                      messages.careCoachSortProgramByRecentUpdated
                    )}
                  </Option> */}
            ...
            <Row className="clearFix-34" />
            <Row className="program-body-row2">{this.getProgramResult()}</Row>
          </div>
        </div>
      </Fragment>
    );
